...
import { boxHeight } from './MainNav.css';
...
const StickyCtn = styled.div``;

export const MainNav2: FC<MainNavProps> = (_props) => {
  ...
  return (
    <div
      style={assignInlineVars({
        [styles.boxHeight]: scrollIsOnTop
    ...
    >
      <div
        ...
        `}
      >
        <div className={'item gutter shrink'}>
          <Link href={'/'}>
            <Image
        ...
        <div className={'shrink'}>
          <img
            src={
              'http://localhost:3000/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsandrine-logo.a672f303.png&w=96&q=85'
            }
        ...
        <div className={'stretch'}>
          Item
          <DateRangeText startAt={new Date()} />
        </div>
        <div className={'shrink'}>
          <button
            onClick={() => {
