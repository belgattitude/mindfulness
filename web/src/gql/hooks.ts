...
export const SearchEventsDocument = `
    query searchEvents($limit: Int = 100, $publicationState: PublicationState = LIVE, $dateMin: DateTime = "2020-02-28T03:00:00.000Z") {
  events(
